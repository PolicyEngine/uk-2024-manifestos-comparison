...
lib_dem_reform = Reform.from_dict(
    {
        ...
        "gov.contrib.policyengine.budget.nhs": {"2024-01-01.2100-12-31": 8.35},
        "gov.contrib.policyengine.budget.other_public_spending": {
        ...
        "gov.dwp.carers_allowance.rate": {"2024-01-01.2100-12-31": 101.9},
        "gov.dwp.universal_credit.elements.child.limit.child_count": {
            "2024-01-01.2100-12-31": 99
        },
        "gov.hmrc.cgt.additional_rate": {"2024-01-01.2100-12-31": 0.25},
        "gov.hmrc.cgt.annual_exempt_amount": {"2024-01-01.2100-12-31": 5000},
...
labour_reform = Reform.from_dict(
    {
        ...
        "gov.contrib.policyengine.budget.nhs": {"2024-01-01.2100-12-31": 2},
        "gov.contrib.policyengine.budget.other_public_spending": {
